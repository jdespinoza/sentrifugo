	...
	public  function reportsheader($module)
	{
	     $reportsheader = '';
		    ...
		    $reportsheader ='<div class="reports-block-area">';
                         if($module != 'main')
                            $reportsheader .='<div class="reports-back-btn-div"><a href="'.BASE_URL.'welcome" class="sprite reports-back-btn">Regresar a Inicio</a><a href="'.BASE_URL.'reports" class="sprite reports-back-btn">Back to Analytics</a>';
                         else
                             $reportsheader .='<div class="back-page-div-report"><a href="'.BASE_URL.'welcome" class="sprite reports-back-btn ">Regresar a Inicio</a>';
			 $reportsheader .='</div>';
