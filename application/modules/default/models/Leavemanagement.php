...
class Default_Model_Leavemanagement extends Zend_Db_Table_Abstract
{
	...
	public function getGrid($sort,$by,$perPage,$pageNo,$searchData,$call,$dashboardcall,$a='',$b='',$c='',$d='')
	{
		...
		$tableFields = array('action'=>'Acción','m.month_name' => 'Mes de Inicio',
                                     'w.week_name' => 'Fin de Semana 1','wk.week_name' => 'Fin de semana 2',
                                     'deptname' => 'Departamento','hours_day' => 'Horas','is_halfday' => 'Medio Día',
                                     'is_leavetransfer' => 'Dejar transferible','is_skipholidays' => 'Saltar Vacaciones',
