	...
	public function getGrid($sort,$by,$perPage,$pageNo,$searchData,$call,$dashboardcall,$objName,$queryflag,$unitId='',$statusidstring='')
	{
		...
		if($objName == 'manageremployeevacations')
		{
		       if($searchData != '' && $searchData!='undefined')
				...
				$tableFields = array('action'=>'Acción','userfullname' => 'Empleado','leavetype' => 'Tipo de Retiro',
                    'from_date' => 'Desde','to_date' => 'Hasta','appliedleavescount' => 'Días','leavestatus' => 'Estado del Retiro');
		...
		else
		{
				...
				if($objName=='pendingleaves' || $objName=='cancelleaves') {
					$tableFields = array('action'=>'Acción','leavetype' => 'Tipo de retiro','reason' => 'Razón',
							'from_date' => 'Fecha Inicio','to_date' => 'Fecha Fin','appliedleavescount' => 'Días',
							'applieddate' => 'Aplicado en');
				}else{
