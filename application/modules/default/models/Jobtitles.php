...
class Default_Model_Jobtitles extends Zend_Db_Table_Abstract
{
	...
	public function getGrid($sort,$by,$perPage,$pageNo,$searchData,$call,$dashboardcall,$exParam1='',$exParam2='',$exParam3='',$exParam4='')
	{
		...
		$tableFields = array('action'=>'Acción','jobtitlecode' => 'Código del Título Profesional','jobtitlename' =>'Título Profesional','jobdescription' => 'Descripción del Trabajo','minexperiencerequired' => 'Experiencia Min. Requerida','jobpaygradecode' => 'Código de Calificación Laboral','freqtype' => 'Frecuencia de Pago','comments' => 'Comentarios');
