...
class Default_Form_Employeereport extends Zend_Form
{
    public function init()
    {
        ...
        $isactive->setLabel("Estado del Usuario")
                            ->addMultiOptions(array('' => 'Seleccionar Estado de Usuario',
                                                    '0' => 'Inactive',
                                                    '1' => 'Active',
                                                    '2' => 'Resigned',
                                                    '3' => 'Left',
