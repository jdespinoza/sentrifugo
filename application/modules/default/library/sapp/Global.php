		...
		if(!empty($menuidArr) && $controllerName != 'servicerequests')
		{
			...
			if($menuID !='')
			{
				...
				if(!empty($settingsmenuArr))
				{
					...
					if(sizeof($settingsmenuArray) <= 16)
					{
						...
						else
						{
                                                        ...
                                                        $settingsdiv = '<div id="pageshortcut" class ="sprite shortcut-icon '.$class.'" onclick="createorremoveshortcut('.$menuID.',1)">Pin para atajos';
							$settingsdiv .='</div>';
						}
					}
				}
				else
				{
                                        ...
                                        $settingsdiv = '<div id="pageshortcut" class ="sprite shortcut-icon '.$class.'" onclick="createorremoveshortcut('.$menuID.',3)">Pin para atajos';
					$settingsdiv .='</div>';
				}
			}
