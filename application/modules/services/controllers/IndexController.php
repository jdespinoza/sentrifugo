            ...
            )
            {
                ...
                if($role_id == SUPERADMINROLE || $group_id == MANAGEMENT_GROUP || $group_id == HR_GROUP)
                {
                    ...
                    if($privilege_flag == 'Yes')
                    {
                        ...
                        $dept_str = sapp_Global::selectOptionBuilder("", "Seleccione Departamento");
                        ...
                        {
                            $status = 0;
                            $message = "Los departamentos aún no están configurados.";
                        }
                    }
                }
            }
                ...
                if($privilege_flag == 'Yes' && $edit_flag == 'Yes')
                {
					...
					}else
					{
					    if($params_arr['userid'] == '')
						    ...
						    $message = "Id Empleado no puede estar vacio";
					}
