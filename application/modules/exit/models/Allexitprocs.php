	...
	public function getGrid($sort,$by,$perPage,$pageNo,$searchData,$call,$dashboardcall,$a='',$b='',$c='',$d='',$status = '')
	{
       ...
       // $searchArray = array();
		...
		if($this->loggedInUserRole != SUPERADMINROLE && $this->is_org_head!=1){
			$tableFields = array('action'=>'Acción','userfullname'=>'Empleado','employeeId'=>'Id Empleado','businessunit_name'=>'Unidad de Negocios','department_name'=>'Departamento','exit_type'=>'Tipo de Salida','overall_status'=>'Estado General','individual_status'=>'Estado Individual','initiateddate' => 'Fecha de Inicio');
		}else{
			$tableFields = array('action'=>'Acción','userfullname'=>'Empleado','employeeId'=>'Id Empleado','businessunit_name'=>'Unidad de Negocios','department_name'=>'Departamento','exit_type'=>'Tipo de Salida','overall_status'=>'Estado General','initiateddate' => 'Fecha de Inicio');
		}
